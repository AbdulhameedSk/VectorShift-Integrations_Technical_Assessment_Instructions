...
CLIENT_ID = '180d872b-594c-802b-b4c3-0037a6851038'
CLIENT_SECRET = 'secret_wddP6kuXvRUVq1os1iM2SY1Otlp7UT5ktB4AUmdSOxN'
encoded_client_id_secret = base64.b64encode(f'{CLIENT_ID}:{CLIENT_SECRET}'.encode()).decode()

REDIRECT_URI = 'http://localhost:8000/integrations/notion/callback'
authorization_url = f'https://api.notion.com/v1/oauth/authorize?client_id=180d872b-594c-802b-b4c3-0037a6851038&response_type=code&owner=user&redirect_uri=http%3A%2F%2Flocalhost%3A8000%2Fintegrations%2Fnotion%2Fcallback'
